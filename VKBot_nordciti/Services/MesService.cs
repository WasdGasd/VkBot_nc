...
namespace VKBot_nordciti.Services
{
    public class MesService : IMessageService
    {
        ...
        public async Task HandleMessageAllowEvent(long userId)
        {
            ...
            var welcomeText = "🎉 *Добро пожаловать в Центр YES!* 🎉\n\n" +
                             "🌈 Мы рады, что вы с нами! Теперь вы будете в курсе всех событий и акций!\n\n" +
                             "🏊‍♂️ *Что я могу для вас сделать:*\n" +
                             "• Помочь купить билеты онлайн\n" +
                             "• Показать текущую загруженность аквапарка\n" +
                             "• Рассказать о времени работы и контактах\n" +
